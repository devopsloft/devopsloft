...
Vagrant.configure("2") do |config|
	...
	config.vm.define "stage" do |stage|
		...
		stage.vm.provider :aws do |aws,override|
			...
			aws.access_key_id = AWS['stage_access_key_id']
			aws.secret_access_key = AWS['stage_secret_access_key']
	...
	config.vm.define "prod" do |prod|
		...
		prod.vm.provider :aws do |aws,override|
			...
			aws.access_key_id = AWS['prod_access_key_id']
			aws.secret_access_key = AWS['prod_secret_access_key']
